/// \file RendererOpenGLExtensions.h
/// \brief Access and setup of OpenGL extensions
///
/// Call setupOpenGLExtensions() to setup OpenGL extensions AFTER the OpenGL window has been created.
/// Do NOT include this header file anywhere except for in RendererOpenGL.cpp, otherwise we'll expose OpenGL API which we don't wanna do.
