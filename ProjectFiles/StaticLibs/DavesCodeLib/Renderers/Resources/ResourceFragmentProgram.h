#ifndef RESOURCE_FRAGMENTPROGRAM_H
#define RESOURCE_FRAGMENTPROGRAM_H

namespace DCL
{
	/// \brief Base class for resource of type fragment program
	///
	...
	class CResourceFragmentProgramBase
	{
	public:
